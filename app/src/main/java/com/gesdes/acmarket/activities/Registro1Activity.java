...
public class Registro1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar=findViewById(R.id.pbCargandoRegistro1);
        etTelefono=findViewById(R.id.etTelefonoRegistro1);
        btnEnviaCodigo=findViewById(R.id.btnEnviaCodigo);
        URL_API=getString(R.string.URL_HOST) +"SendSMSPolar";
    }

    public void btnenviaWhats(View view){
        telefono =etTelefono.getText().toString();
        enviaMensaje(true);
    }

    public void btnYaTengoCodigo(View view){
        telefono =etTelefono.getText().toString();
        enviaMensaje(true);
    }
    ...
    public void enviaMensaje(boolean Whats){
        ...
        try {
            ...
            datos.put("TENGO_UN_CODIGO", Whats);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(result == 1){
                                ...
                                Intent main=new Intent(getApplicationContext(), Registro2Activity.class);
    ...
    public boolean validate(){
        if(telefono.isEmpty()){
            etTelefono.setError("¡Nùmero celular no puede estar vacío!");
            return false;
        }
        if(telefono.length()!=10){
            etTelefono.setError("¡Nùmero celular debe contener 10 dìgitos!");
            return false;
        }
    ...
    private void _ShowAlert(String title, String mensaje){
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(Registro1Activity.this).create();
